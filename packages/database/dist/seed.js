...
async function main() {
    ...
    const documentRequirements = [
        // Income Documents
        {
            ...
            isRequired: true,
            sortOrder: 1,
            programTypes: ['HCV', 'PUBLIC_HOUSING', 'PBV', 'PBRA', 'ARO', 'LIHTC', 'OTHER'],
        },
        {
            id: 'bank-statements',
        ...
        },
        {
            ...
            isRequired: true,
            sortOrder: 3,
            programTypes: ['HCV', 'PUBLIC_HOUSING', 'PBV', 'PBRA'],
        },
        {
            id: 'benefit-letters',
        ...
        },
        {
            ...
            isRequired: true,
            sortOrder: 21,
            programTypes: ['HCV', 'PUBLIC_HOUSING'],
        },
        {
            id: 'utility-bills',
            name: 'Utility Bills',
