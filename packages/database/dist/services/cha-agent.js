...
export async function analyzeDataStructure(buffer, filename) {
 ...
 */
export async function extractHousingData(buffer, analysis) {
...
export async function validateExtraction(extracted) {
...
export function saveCache(sources) {
    try {
